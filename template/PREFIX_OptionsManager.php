        ...
        <div class="wrap">
            ...
            <tr><td><?php _e('PHP Version', 'TEXT_DOMAIN'); ?></td>
                ...
                if (version_compare('5.2', phpversion()) > 0) {
                    ...
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'TEXT_DOMAIN');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'TEXT_DOMAIN'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'TEXT_DOMAIN');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'TEXT_DOMAIN'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'TEXT_DOMAIN') ?>"/>
                </p>
            </form>
        </div>
        <?php
