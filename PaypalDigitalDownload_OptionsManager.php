...
class PaypalDigitalDownload_OptionsManager {
    ...
    public function settingsPage() {
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'paypal-digital-download'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'paypal-digital-download'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'paypal-digital-download'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'paypal-digital-download');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'paypal-digital-download'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'paypal-digital-download');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'paypal-digital-download'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'paypal-digital-download') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'paypal-digital-download');
            case 'false':
                return __('false', 'paypal-digital-download');

            case 'Administrator':
                return __('Administrator', 'paypal-digital-download');
            case 'Editor':
                return __('Editor', 'paypal-digital-download');
            case 'Author':
                return __('Author', 'paypal-digital-download');
            case 'Contributor':
                return __('Contributor', 'paypal-digital-download');
            case 'Subscriber':
                return __('Subscriber', 'paypal-digital-download');
            case 'Anyone':
                return __('Anyone', 'paypal-digital-download');
        }
        return $optionValue;
    }
