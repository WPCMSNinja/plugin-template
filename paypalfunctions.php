...
$SandboxFlag = false;  // MIKE change this to true for testing
//' TODO:
//'------------------------------------
...
//'------------------------------------
$API_UserName="seller_1360444266_biz_api1.gmail.com";
$API_Password="1360444286";
$API_Signature="AmnpBjhy1yyZZcPPusXRi9ePbmldAYbRv-ORQNiUIAarezCunt61yvI8";

if ($SandboxFlag == false)
{
    // REAL Credentials
    $API_UserName="michael.d.simpson_api1.gmail.com";
    $API_Password="VBRZZ5JB4AQ6Y2YN";
    $API_Signature="AgjE0qClTjboZgeZZjFEyfiXf5e3ArreSZPqW5jIbeMMHZcz6MRsYj68";
}
