...
if ( $PaymentOption == "PayPal")
{
    ...
    //'------------------------------------
//    $returnURL = admin_url('admin-ajax.php') . '?action=pddorderconfirm'; // todo
//    $returnURL = 'http://cfdbplugin.com/wp-admin/admin-ajax.php?action=pddorderconfirm'; // todo
    $returnURL = 'http://cfdbplugin.com/wp-content/plugins/paypal-digital-download/orderconfirm.php'; // todo
    ...
    //' This is set to the value entered on the Integration Assistant
    //'------------------------------------
//    $cancelURL = admin_url('admin-ajax.php') . '?action=pddcancel'; // todo
//    $cancelURL = 'http://plugin.michael-simpson.com/wp-admin/admin-ajax.php?action=pddcancel'; // todo
    $cancelURL = 'http://cfdbplugin.com/wp-content/plugins/paypal-digital-download/cancel.php'; // todo
    ...
    $items = array();
    $items[] = array('name' => 'CFDB Editor Plugin', 'amt' => $paymentAmount, 'qty' => 1);
